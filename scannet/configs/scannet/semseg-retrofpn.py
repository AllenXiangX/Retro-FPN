...
model = dict(
    type="retrofpn",
    in_channels=9,
    num_classes=20, # 21 for weighted...  should be 20 for normal training
    patch_embed_depth=1,
...
# scheduler settings
epoch = 900  # 300 for finetuning retro, 900 for ptv2s
optimizer = dict(type='AdamW', lr=0.005, weight_decay=0.02)  # 0.001 for finetuning, 0.005 for original training
...
data_root = "/data1/xp/data/ScanNet_ptv2"

data = dict(
    num_classes=20,  # 21 xp
    ignore_label=255,
