...
def main_process():
    ...
    parser.add_argument('--dataset_root', type=str,
                        default='/localdata_ssd/xiaoyu/xiangp/Stanford3dDataset_v1.2_Aligned_Version')
                        # default='/home/gofinge/Documents/datasets/Stanford3dDataset_v1.2')
    parser.add_argument('--output_root', type=str,
                        default='/localdata_ssd/xiaoyu/xiangp/s3dis_ptv2')
    ...
    opt.save_root = '/localdata_ssd/xiaoyu/xiangp/s3dis_ptv2_save_root'  #  opt.output_root
    room_list = []
