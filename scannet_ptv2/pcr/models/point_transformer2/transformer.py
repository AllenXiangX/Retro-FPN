...
class CrossAttention(nn.Module):
    ...
    def forward(self, pxo, pxo2):
        ...
        x_k, idx = pointops.query_and_group2(self.n_samples, p2, p, x_k, None, o2, o)
...
class RetroTransformer(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=32, n_groups=4, n_samples=12):
